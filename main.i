...
enum {BLACKID=(256-9), BLUEID, GREENID, REDID, WHITEID, GRAYID, MAGENTAID, CYANID, YELLOWID};
extern unsigned short colors[9];


extern PADDLE paddle;
extern BRICK bricks[20];
extern BALL ball;
...
# 1 "breakoutStart.h" 1
# 21 "breakoutStart.h"
extern const unsigned short breakoutStartBitmap[19200];


extern const unsigned short breakoutStartPal[256];
# 7 "main.c" 2
...
void goToStart(){
    DMANow(3, &breakoutStartPal, ((unsigned short *)0x5000000), 256);
